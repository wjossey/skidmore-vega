...
public class VertexHelper {
	 ...
	 * @return
	 */
	public static <V extends Vertex<V,E>, E extends Edge<V,E>> Graph<V,E> generateVertices(Graph<V, E> g){
		Graph<V, E> graph = g;
	...
	public static <V extends Vertex<V,E>, E extends Edge<V,E>> ArrayList<V> getKNearestNeighbors(V vertex, int k){
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <V extends Vertex<V,E>, E extends Edge<V,E>> ArrayList<V> getNearestNeighbors(V vertex){
	...
	@SuppressWarnings("unchecked")
	public static <V extends Vertex<V,E>, E extends Edge<V,E>> V getNearestNeighbor(V vertex){
     ...
     * @return
     */
    public static <V extends Vertex<V,E>, E extends Edge<V,E>> String vertexListToString(ArrayList<V> vertexList) {
        String returnString = "";
